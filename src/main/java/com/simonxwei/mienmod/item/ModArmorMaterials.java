...
//    自制盔甲
    public static final RegistryEntry<ArmorMaterial> ICE_ETHER = register(
            ...
            3.0F, 0.1F,
            () -> Ingredient.ofItems(new ItemConvertible[]{ModItems.ICE_ETHER})
    );
...
//    普通盔甲也调用了皮革的注册方法，因此直接复制即可
    private static RegistryEntry<ArmorMaterial> register(
        ...
        List<ArmorMaterial.Layer> list = List.of(new ArmorMaterial.Layer(Identifier.of(MienMod.MOD_ID, id)));
